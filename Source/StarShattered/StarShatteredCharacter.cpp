...
AStarShatteredCharacter::AStarShatteredCharacter()
{
...
float AStarShatteredCharacter::TakeDamage(float DamageAmount, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, AActor* DamageCauser)
{
	...
	float DamageAfterResistance = ActualDamage * FMath::Clamp(1.0f - (Resistance / 100.0f), 0.0f, 1.0f);
...
void AStarShatteredCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AStarShatteredCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AStarShatteredCharacter::Look);
	}
	else
	{
...
void AStarShatteredCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
